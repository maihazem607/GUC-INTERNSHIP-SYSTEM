      ...
      <div className={styles.videoCallModal}>
        <div className={styles.videoCallContainer}>
              ...
              <div className={styles.videoPlaceholder}>
                ...
                {isScreenSharing && (
                  <div className={styles.screenShareIndicator}>
                    <span className={styles.shareIcon}><ScreenShare size={16} color="#4c51bf" /></span> Sharing screen
                  </div>
                )}
              </div>
            ) : (
              <div className={styles.leftCallMessage}>
                <div className={styles.leftCallIcon}><Hand size={32} color="#4c51bf" /></div>
          ...
          >
            ...
            >
              <span className={styles.controlIcon}>
                {isVideoEnabled ? <Camera size={20} color="#fff" /> : <CameraOff size={20} color="#fff" />}
              </span>
            ...
            >
              <span className={styles.controlIcon}>
                {isScreenSharing ? <StopCircle size={20} color="#fff" /> : <Monitor size={20} color="#fff" />}
              </span>
            ...
            <button
              ...
              title="End call"
            >
              <span className={styles.controlIcon}><PhoneOff size={20} color="#fff" /></span>
