                ...
                <div className={styles.barChart}>
                  <div className={styles.barGroup}>
                    <div 
                      ...
                      style={{
                        height: `${Math.max((data.reports.accepted / data.reports.total) * 100, 10)}%`,
                      }}
                    >
                  ...
                  <div className={styles.barGroup}>
                    <div 
                      ...
                      style={{
                        height: `${Math.max((data.reports.rejected / data.reports.total) * 100, 10)}%`,
                      }}
                    >
                  ...
                  <div className={styles.barGroup}>
                    <div 
                      ...
                      style={{
                        height: `${Math.max((data.reports.flagged / data.reports.total) * 100, 10)}%`,
                      }}
                    >
                    ...
                    <svg width="180" height="180" viewBox="0 0 100 100">
                      <path 
                        d={`M 50 50 L 50 10 A 40 40 0 0 1 ${
                          50 + 40 * Math.cos((data.reports.accepted / data.reports.total) * Math.PI * 2)
                        } ${
                          50 - 40 * Math.sin((data.reports.accepted / data.reports.total) * Math.PI * 2)
                        } Z`}
                        fill="#22c55e"
                      />
                      ...
                      <path 
                        d={`M 50 50 L ${
                          ...
                          50 + 40 * Math.cos(((data.reports.accepted + data.reports.rejected) / data.reports.total) * Math.PI * 2)
                        } ${
                          50 - 40 * Math.sin(((data.reports.accepted + data.reports.rejected) / data.reports.total) * Math.PI * 2)
                        } Z`}
                        fill="#ef4444"
                      />
      ...
      return (
        <div className={styles.reportStatsContainer}>
          <div className={styles.chartContainer}>
            ...
            <div className={styles.chartPlaceholder}>
              {chartView === 'bar' && (                <div className={styles.barChart}>
                  <div className={styles.barGroup}>
                    <div 
                      className={`${styles.bar} ${styles.accepted}`} 
                      style={{
