...
import { Building, Users, FileText, ClipboardCheck, Briefcase, BarChart2, Calendar, Settings, BookOpen, ArrowLeft } from 'lucide-react';

// Student data type to match the dashboard
interface Student {
  id: number;
  name: string;
  email: string;
